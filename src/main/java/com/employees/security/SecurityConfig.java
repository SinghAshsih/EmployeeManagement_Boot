...
public class SecurityConfig {
	...
	public UserDetailsService userDetailService() {
		UserDetails user1 = User.withDefaultPasswordEncoder().username("Ashish").password("@Ashish").build();

		UserDetails user2 = User.withDefaultPasswordEncoder().username("Ram").password("@Ram").build();
